...
<!-- Mirrored from shreethemes.net/jobstock-landing-2.2/jobstock/candidate-detail.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 26 Sep 2024 02:52:32 GMT -->
...
<div id="main-wrapper">
            ...
            <nav id="navigation" class="navigation navigation-landscape">
                <div class="nav-header">
                    <a class="nav-brand" href="#">
                        <img src="../../webapp/assets/img/logo.png" class="logo" alt="">
                    </a>
                    ...
                    <div class="cndt-head-block">
                        ...
                        <div class="cndt-head-left">
                            <div class="cndt-head-thumb">
                                <figure><img src="../../webapp/assets/img/team-1.jpg" class="img-fluid circle" alt="">
                                </figure>
                            </div>
                            <div class="cndt-head-caption">
                                <div class="cndt-head-caption-top">
                                    <div class="cndt-yior-1"><span
                                            class="label text-sm-muted text-success bg-light-success">Featured</span>
                                    </div>
                                    <div class="cndt-yior-2"><h4 class="cndt-title">Dhananjay Preet</h4></div>
                                ...
                                <div class="row align-items-center justify-content-between gy-4">
                                    <div class="col-xl-6 col-lg-6 col-md-6">
                                        <div class="cdtx-infr-box">
                                            <div class="cdtx-infr-icon"><i class="fa-solid fa-envelope-open-text"></i>
                                            </div>
                                ...
                                <div class="resumes-groups-blox">
                                    ...
                                    <div class="single-resumes-blocks">
                                        <div class="single-resumes-left">
                                            <div class="single-resumes-icons"><i class="fa-solid fa-file-word"></i>
                                            </div>
                                            <div class="single-resumes-captions"><h5>Daniel-Resume.doc-2022<span>1 Year ago</span>
                                            </h5></div>
                                        </div>
                                    ...
                                    <div class="single-resumes-blocks">
                                        <div class="single-resumes-left">
                                            ...
                                            <div class="single-resumes-captions"><h5>Daniel-Resume.doc-2023<span>10 Days ago</span>
                                            </h5></div>
                                        </div>
                                        <div class="single-resumes-right">
                                            <button type="button" class="btn btn-md btn-light-success">Download<i
                            ...
                            <div class="single-cdtsr-body">
                                <div class="experinc-usr-groups">
                                    ...
                                    <div class="single-experinc-block">
                                        <div class="single-experinc-lft">
                                            <div class="experinc-thumbs">
                                                <figure><img src="../../webapp/assets/img/l-1.png" class="img-fluid"
                                                             alt=""></figure>
                                            </div>
                                        </div>
                                        <div class="single-experinc-rght">
                                            <div class="experinc-emp-title"><h5>Linked In</h5><span
                                                    class="label text-success bg-light-success">Full Time</span></div>
                                            <div class="experinc-post-title">
                                                <h6>Sr. Web Designer</h6>
                                                <div class="experinc-infos-list"><span
                                                        class="exp-start">5 Years 1 Month</span><span
                                    ...
                                    <div class="single-experinc-block">
                                        <div class="single-experinc-lft">
                                            <div class="experinc-thumbs">
                                                <figure><img src="../../webapp/assets/img/l-2.png" class="img-fluid"
                                                             alt=""></figure>
                                            </div>
                                        </div>
                                        <div class="single-experinc-rght">
                                            <div class="experinc-emp-title"><h5>Dribbble Ltd.</h5><span
                                                    class="label text-warning bg-light-warning">Part Time</span></div>
                                            <div class="experinc-post-title">
                                                <h6>Sr. Product Designer</h6>
                                                <div class="experinc-infos-list"><span
                                                        class="exp-start">2 Years 3 Month</span><span
                                    ...
                                    <div class="single-experinc-block">
                                        <div class="single-experinc-lft">
                                            <div class="experinc-thumbs">
                                                <figure><img src="../../webapp/assets/img/l-3.png" class="img-fluid"
                                                             alt=""></figure>
                                            </div>
                                        </div>
                                        <div class="single-experinc-rght">
                                            <div class="experinc-emp-title"><h5>Google Inc.</h5><span
                                                    class="label text-success bg-light-success">Full Time</span></div>
                                            <div class="experinc-post-title">
                                                <h6>Sr. Team Leader</h6>
                                                <div class="experinc-infos-list"><span
                                                        class="exp-start">4 Years 7 Month</span>.<span
                            ...
                            <div class="single-cdtsr-body">
                                <div class="educations-usr-groups">
                                    ...
                                    <div class="single-educations-block">
                                        <div class="single-educations-lft">
                                            <div class="educations-thumbs">
                                                <figure><img src="../../webapp/assets/img/l-4.png" class="img-fluid"
                                                             alt=""></figure>
                                            </div>
                                        </div>
                                        <div class="single-educations-rght">
                                            ...
                                            <div class="educations-infos-list"><span
                                                    class="exp-start">Jun 2008</span><span class="work-exp-date">Meeruth, UP</span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="single-educations-block">
                                        <div class="single-educations-lft">
                                            <div class="educations-thumbs">
                                                <figure><img src="../../webapp/assets/img/l-5.png" class="img-fluid"
                                                             alt=""></figure>
                                            </div>
                                        </div>
                                        <div class="single-educations-rght">
                                            <div class="educations-emp-title"><h5>Shatrapati Shiva Ji Maharaja
                                                University</h5></div>
                                            <div class="educations-post-title">
                                                <h6>Master Degree in Computer Science</h6>
                                            </div>
                                            <div class="educations-infos-list"><span
                                                    class="exp-start">Jun 2013</span><span class="work-exp-date">Faizabad, UP</span>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="single-cdtsr-body">
                                <div class="row gx-3 gy-3">
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-6 col-6">
                                        <div class="cndts-prt-block">
                                            <div class="cndts-prt-thumb">
                                                <img src="../../webapp/assets/img/blog-1.jpg" class="img-fluid rounded"
                                                     alt="">
                                            </div>
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-6 col-6">
                                        <div class="cndts-prt-block">
                                            <div class="cndts-prt-thumb">
                                                <img src="../../webapp/assets/img/blog-2.jpg" class="img-fluid rounded"
                                                     alt="">
                                            </div>
                                            <div class="cndts-prt-link"><a href="JavaScript:Void(0);"><i
                                                    class="fa-solid fa-arrow-up-right-from-square"></i></a></div>
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-6 col-6">
                                        <div class="cndts-prt-block">
                                            <div class="cndts-prt-thumb">
                                                <img src="../../webapp/assets/img/blog-3.jpg" class="img-fluid rounded"
                                                     alt="">
                                            </div>
                                            <div class="cndts-prt-link"><a href="JavaScript:Void(0);"><i
                                                    class="fa-solid fa-arrow-up-right-from-square"></i></a></div>
                                        ...
                                        <div class="jbs-list-box border">
                                            <div class="jbs-list-head m-0">
                                                <div class="jbs-list-head-thunner">
                                                    <div class="jbs-list-usrs-thumb jbs-verified"><a
                                                            href="candidate-detail.html">
                                                        <figure><img src="../../webapp/WEB-INF/assets/img/team-1.jpg"
                                                                     class="img-fluid circle" alt=""></figure>
                                                    </a></div>
                                                    <div class="jbs-list-job-caption">
                                                        <div class="jbs-job-title-wrap"><h4><a
                                                                href="candidate-detail.html" class="jbs-job-title">Kr.
                                                            Dhananjay Preet</a></h4></div>
                                                ...
                                                <div class="jbs-list-head-middle">
                                                    <div class="elsocrio-jbs sm">
                                                        ...
                                                        <h5 class="jbs-list-pack">7 Years Exp.</h5></div>
                                                </div>
                                                <div class="jbs-list-head-last">
                                                    <a href="JavaScript:Void(0);" class="btn btn-md btn-primary px-3">View
                                                        Detail</a>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="jbs-list-box border">
                                            <div class="jbs-list-head m-0">
                                                <div class="jbs-list-head-thunner">
                                                    <div class="jbs-list-usrs-thumb jbs-verified"><a
                                                            href="candidate-detail.html">
                                                        <figure><img src="../../webapp/WEB-INF/assets/img/team-6.jpg"
                                                                     class="img-fluid circle" alt=""></figure>
                                                    </a></div>
                                                    <div class="jbs-list-job-caption">
                                                        <div class="jbs-job-title-wrap"><h4><a
                                                                href="candidate-detail.html" class="jbs-job-title">Clarence
                                                            B. Mantooth</a></h4></div>
                                                        <div class="jbs-job-mrch-lists">
                                                            <div class="single-mrch-lists">
                                                                <span>Sr. Content Writer</span>.<span><i
                                                ...
                                                <div class="jbs-list-head-middle">
                                                    <div class="elsocrio-jbs sm">
                                                        <div class="ilop-tr"><i class="fa-solid fa-coins"></i></div>
                                                        <h5 class="jbs-list-pack">3 Years Exp.</h5></div>
                                                </div>
                                                <div class="jbs-list-head-last">
                                                    <a href="JavaScript:Void(0);" class="btn btn-md btn-primary px-3">View
                                                        Detail</a>
                                        ...
                                        <div class="jbs-list-box border">
                                            <div class="jbs-list-head m-0">
                                                <div class="jbs-list-head-thunner">
                                                    <div class="jbs-list-usrs-thumb jbs-verified"><a
                                                            href="candidate-detail.html">
                                                        <figure><img src="../../webapp/WEB-INF/assets/img/team-7.jpg"
                                                                     class="img-fluid circle" alt=""></figure>
                                                    </a></div>
                                                    <div class="jbs-list-job-caption">
                                                        <div class="jbs-job-title-wrap"><h4><a
                                                                href="candidate-detail.html" class="jbs-job-title">Geraldine
                                                            E. Scott</a></h4></div>
                                                        <div class="jbs-job-mrch-lists">
                                                            <div class="single-mrch-lists">
                                                                <span>Shopify Developer</span>.<span><i
                                                                    class="fa-solid fa-location-dot me-1"></i>Denver, USA</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="jbs-list-head-middle">
                                                    <div class="elsocrio-jbs sm">
                                                        <div class="ilop-tr"><i class="fa-solid fa-coins"></i></div>
                                                        <h5 class="jbs-list-pack">8 Years Exp.</h5></div>
                                                </div>
                                                <div class="jbs-list-head-last">
                                                    <a href="JavaScript:Void(0);" class="btn btn-md btn-primary px-3">View
                                                        Detail</a>
                                        ...
                                        <div class="jbs-list-box border">
                                            <div class="jbs-list-head m-0">
                                                <div class="jbs-list-head-thunner">
                                                    <div class="jbs-list-usrs-thumb jbs-verified"><a
                                                            href="candidate-detail.html">
                                                        <figure><img src="../../webapp/WEB-INF/assets/img/team-8.jpg"
                                                                     class="img-fluid circle" alt=""></figure>
                                                    </a></div>
                                                    <div class="jbs-list-job-caption">
                                                        <div class="jbs-job-title-wrap"><h4><a
                                                                href="candidate-detail.html" class="jbs-job-title">Donald
                                                            J. Merrick</a></h4></div>
                                                        <div class="jbs-job-mrch-lists">
                                                            <div class="single-mrch-lists">
                                                                <span>Laravel Developer</span>.<span><i
                                                ...
                                                <div class="jbs-list-head-middle">
                                                    <div class="elsocrio-jbs sm">
                                                        <div class="ilop-tr"><i class="fa-solid fa-coins"></i></div>
                                                        <h5 class="jbs-list-pack">5 Years Exp.</h5></div>
                                                </div>
                                                <div class="jbs-list-head-last">
                                                    <a href="JavaScript:Void(0);" class="btn btn-md btn-primary px-3">View
                                                        Detail</a>
                        ...
                        <div class="sidefr-usr-body">
                            <form>
                                ...
                                <div class="form-group m-0">
                                    <button type="button" class="btn btn-primary fw-medium full-width">Send Message
                                    </button>
                                </div>
                            </form>
                        </div>
                        ...
                        <div class="cndts-share-block">
                            ...
                            <div class="cndts-share-list">
                                <ul>
                                    ...
                                    <li><a href="JavaScript:Void(0);"><i class="fa-brands fa-google-plus-g"></i></a>
                                    </li>
    ...
    <section class="bg-cover primary-bg-dark"
             style="background:url(../../webapp/WEB-INF/assets/img/footer-bg-dark.png)no-repeat;">
        <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-4">
                        <div class="footer-widget">
                            <img src="../../webapp/WEB-INF/assets/img/logo.png" class="img-footer" alt="">
                        ...
                        <div class="footer-widget">
                            ...
                            <div class="app-wrap">
                                <p><a href="JavaScript:Void(0);"><img
                                        src="../../webapp/WEB-INF/assets/img/light-play.png" class="img-fluid"
                                        alt=""></a></p>
                                <p><a href="JavaScript:Void(0);"><img
                                        src="../../webapp/WEB-INF/assets/img/light-ios.png" class="img-fluid"
                                        alt=""></a></p>
                            </div>
                        </div>
                    </div>
        ...
        <div class="modal-dialog modal-dialog-centered login-pop-form" role="document">
            <div class="modal-content" id="loginmodal">
                ...
                <div class="modal-header">
                    <div class="mdl-thumb"><img src="../../webapp/WEB-INF/assets/img/ico.png" class="img-fluid"
                                                width="70" alt=""></div>
