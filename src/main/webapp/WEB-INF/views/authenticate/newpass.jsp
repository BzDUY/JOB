        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12">
                    <h2 class="ipt-title text-light"><i class="bi bi-shield-lock-fill"></i> Create New Password</h2>
                    <span class="text-light opacity-75">Please remember your new password carefully.</span>
                </div>
            </div>
        </div>
    </section>
                            ...
                            <ul class="nav nav-pills mb-3 justify-content-center" id="pills-tab" role="tablist">
                                <li class="nav-item">
                                    <button class="nav-link active" id="register-tab" data-bs-toggle="pill"
                                            ...
                                            aria-selected="true"><i class="bi bi-pencil-square"></i> Create NewPass
                                    </button>
                                </li>
                            </ul>
                                ...
                                <div class="tab-pane fade show active" id="register" role="tabpanel"
                                    ...
                                    <div class="row gx-3 gy-4">
                                        <div class="modal-login-form">
                                            ...
                                            <!-- Form đăng ký với nút hiển thị mật khẩu -->
                                            <form action="${pageContext.request.contextPath}/newpass" method="post" onsubmit="return validatePassword()">
                                                ...
                                                <div class="form-floating mb-4 position-relative">
                                                    ...
                                                    <!-- Nút mắt -->
                                                    <i class="bi bi-eye position-absolute top-50 end-0 me-3" style="cursor: pointer; transform: translateY(-50%);" onclick="togglePasswordVisibility('password', this)"></i>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    <button type="submit" class="btn btn-primary full-width font--bold btn-lg">Create NewPass</button>
                                                </div>
                                            </form>

                                            <!-- JavaScript để hiển thị/ẩn mật khẩu -->
                                            <script>
