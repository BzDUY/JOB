                            ...
                            <ul class="nav nav-pills mb-3 justify-content-center" id="pills-tab" role="tablist">
                                <li class="nav-item">
                                    <button class="nav-link active" id="register-tab" data-bs-toggle="pill"
                                            ...
                                            aria-selected="true">Create Account
                                    </button>
                                </li>
                            </ul>
                                        ...
                                        <div class="modal-login-form">
                                            <form action="${pageContext.request.contextPath}/signup" method="post">
                                                ...
                                                <div class="form-group">
                                                    <button type="submit"
                                                            class="btn btn-primary full-width font--bold btn-lg">Create
                                                        An Account
                                                    </button>
                                                </div>
                                            </form>
                                            <div class="modal-footer">
                                                <p>I have an account!!<a
                                                        href="${pageContext.request.contextPath}/login"
                                                        class="text-primary font--bold ms-1">Login</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
