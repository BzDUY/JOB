        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12">
                    <h2 class="ipt-title text-light"><i class="bi bi-shield-lock"></i> Forgot Password</h2>
                    <span class="text-light opacity-75">Recover password</span>
                </div>
            </div>
        </div>
    </section>
                            ...
                            <ul class="nav nav-pills mb-3 justify-content-center" id="pills-tab" role="tablist">
                                <li class="nav-item">
                                    <button class="nav-link active" id="register-tab" data-bs-toggle="pill"
                                            ...
                                            aria-selected="true"><i class="bi bi-envelope-check"></i> Recover Password
                                    </button>
                                </li>
                            </ul>
                                    ...
                                    <div class="row gx-3 gy-4">
                                        <div class="modal-login-form">
                                            ...
                                            <div class="modal-footer">
                                                <p><i class="bi bi-person"></i> I have an account!
                                                    <a href="${pageContext.request.contextPath}/login"
                                                       class="text-primary font--bold ms-1"><i class="bi bi-box-arrow-in-right"></i> Login</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
