...
<html lang="en">
    <head>
        ...
        <link href="${pageContext.request.contextPath}/assets/css/cvcreatecss.css" rel="stylesheet">
        ...
        <header class="custom-header">
            <nav class="navbar navbar-expand-lg static-top navbar-dark">
                <div class="container" style="display: flex; align-items: center">
                    <div class="">
                        <img src="../assets/img/logo-light1.png" alt="alt"/>
                    </div>
                    <button
