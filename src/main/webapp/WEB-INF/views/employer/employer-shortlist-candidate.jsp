...
<!-- Mirrored from shreethemes.net/jobstock-landing-2.2/jobstock/employer-shortlist-candidates.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 26 Sep 2024 02:53:13 GMT -->
                    ...
                    <div class="colxl-12 col-lg-12 col-md-12">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="#" class="text-primary">Shortlisted Candidates</a></li>
                            </ol>
                        </nav>
                    </div>
                </div>
                                ...
                                <div class="row justify-content-start gx-3 gy-4">
                                        ...
                                        <div class="jbs-list-box border">
                                            <div class="jbs-list-head m-0">
                                                ...
                                                <div class="jbs-list-head-last">
                                                    <a href="JavaScript:Void(0);" class="rounded btn-md text-info bg-light-info px-3"><i class="fa-solid fa-eye"></i></a>
                                                    <a href="JavaScript:Void(0);" class="rounded btn-md text-success bg-light-success px-3"><i class="fa-solid fa-envelope-circle-check"></i></a>
                                            ...
                                            <div class="jbs-list-head m-0">
                                                <div class="jbs-list-head-thunner">
                                                    ...
                                                    <div class="jbs-list-job-caption">
                                                        ...
                                                        <div class="jbs-job-mrch-lists">
                                                            <div class="single-mrch-lists">
                                                                <span>Team Manager</span>.<span><i class="fa-solid fa-location-dot me-1"></i>New York, USA</span>
                                                            </div>
                                                        </div>
                                                        <div class="jbs-grid-job-edrs-group mt-1">
                                                            <span>HTML</span>
                                                ...
                                                <div class="jbs-list-head-middle">
                                                    <div class="elsocrio-jbs sm"><div class="ilop-tr"><i class="fa-solid fa-coins"></i></div><h5 class="jbs-list-pack">2 Years Exp.</h5></div>
                                                </div>
                                                <div class="jbs-list-head-last">
                                                    <a href="JavaScript:Void(0);" class="rounded btn-md text-info bg-light-info px-3"><i class="fa-solid fa-eye"></i></a>
                                                    <a href="JavaScript:Void(0);" class="rounded btn-md text-success bg-light-success px-3"><i class="fa-solid fa-envelope-circle-check"></i></a>
                                            ...
                                            <div class="jbs-list-head m-0">
                                                <div class="jbs-list-head-thunner">
                                                    ...
                                                    <div class="jbs-list-job-caption">
                                                        ...
                                                        <div class="jbs-job-mrch-lists">
                                                            <div class="single-mrch-lists">
                                                                <span>Front-End Designer</span>.<span><i class="fa-solid fa-location-dot me-1"></i>California, USA</span>
                                                            </div>
                                                        </div>
                                                        <div class="jbs-grid-job-edrs-group mt-1">
                                                            <span>HTML</span>
                                                ...
                                                <div class="jbs-list-head-middle">
                                                    <div class="elsocrio-jbs sm"><div class="ilop-tr"><i class="fa-solid fa-coins"></i></div><h5 class="jbs-list-pack">4 Years Exp.</h5></div>
                                                </div>
                                                <div class="jbs-list-head-last">
                                                    <a href="JavaScript:Void(0);" class="rounded btn-md text-info bg-light-info px-3"><i class="fa-solid fa-eye"></i></a>
                                                    <a href="JavaScript:Void(0);" class="rounded btn-md text-success bg-light-success px-3"><i class="fa-solid fa-envelope-circle-check"></i></a>
                                            ...
                                            <div class="jbs-list-head m-0">
                                                <div class="jbs-list-head-thunner">
                                                    ...
                                                    <div class="jbs-list-job-caption">
                                                        ...
                                                        <div class="jbs-job-mrch-lists">
                                                            <div class="single-mrch-lists">
                                                                <span>UI/UX Designer</span>.<span><i class="fa-solid fa-location-dot me-1"></i>Canada, USA</span>
                                                            </div>
                                                        </div>
                                                        <div class="jbs-grid-job-edrs-group mt-1">
                                                            <span>HTML</span>
                                                ...
                                                <div class="jbs-list-head-middle">
                                                    <div class="elsocrio-jbs sm"><div class="ilop-tr"><i class="fa-solid fa-coins"></i></div><h5 class="jbs-list-pack">10 Years Exp.</h5></div>
                                                </div>
                                                <div class="jbs-list-head-last">
                                                    <a href="JavaScript:Void(0);" class="rounded btn-md text-info bg-light-info px-3"><i class="fa-solid fa-eye"></i></a>
                                                    <a href="JavaScript:Void(0);" class="rounded btn-md text-success bg-light-success px-3"><i class="fa-solid fa-envelope-circle-check"></i></a>
                                            ...
                                            <div class="jbs-list-head m-0">
                                                <div class="jbs-list-head-thunner">
                                                    ...
                                                    <div class="jbs-list-job-caption">
                                                        ...
                                                        <div class="jbs-job-mrch-lists">
                                                            <div class="single-mrch-lists">
                                                                <span>Content Writer</span>.<span><i class="fa-solid fa-location-dot me-1"></i>Liverpool, UK</span>
                                                            </div>
                                                        </div>
                                                        <div class="jbs-grid-job-edrs-group mt-1">
                                                            <span>HTML</span>
                                            ...
                                            <div class="jbs-list-head m-0">
                                                <div class="jbs-list-head-thunner">
                                                    ...
                                                    <div class="jbs-list-job-caption">
                                                        ...
                                                        <div class="jbs-job-mrch-lists">
                                                            <div class="single-mrch-lists">
                                                                <span>WordPress Developer</span>.<span><i class="fa-solid fa-location-dot me-1"></i>New York, USA</span>
                                                            </div>
                                                        </div>
                                                        <div class="jbs-grid-job-edrs-group mt-1">
                                                            <span>HTML</span>
                                    ...
                                    <div class="col-xl-12 col-lg-12 col-md-12 col-12">
                                        <div class="jbs-list-box border">
                                            <div class="jbs-list-head m-0">
                                                <div class="jbs-list-head-thunner">
                                                    <div class="jbs-list-usrs-thumb jbs-verified"><a href="candidate-detail.html"><figure><img src="../../webapp/WEB-INF/assets/img/team-14.jpg" class="img-fluid circle" alt=""></figure></a></div>
                                                    <div class="jbs-list-job-caption">
                                                        <div class="jbs-job-title-wrap"><h4><a href="candidate-detail.html" class="jbs-job-title">Jewel E. Gardner</a></h4></div>
                                                        <div class="jbs-job-mrch-lists">
                                                            <div class="single-mrch-lists">
                                                                <span>PHP Developer</span>.<span><i class="fa-solid fa-location-dot me-1"></i>London, UK</span>
                                                            </div>
                                                        </div>
                                                        <div class="jbs-grid-job-edrs-group mt-1">
                                                            <span>HTML</span>
                                            ...
                                            <div class="jbs-list-head m-0">
                                                <div class="jbs-list-head-thunner">
                                                    ...
                                                    <div class="jbs-list-job-caption">
                                                        ...
                                                        <div class="jbs-job-mrch-lists">
                                                            <div class="single-mrch-lists">
                                                                <span>Sr. Web Designer</span>.<span><i class="fa-solid fa-location-dot me-1"></i>Canada, USA</span>
                                                            </div>
                                                        </div>
                                                        <div class="jbs-grid-job-edrs-group mt-1">
                                                            <span>HTML</span>
