...
<!-- Mirrored from shreethemes.net/jobstock-landing-2.2/jobstock/employer-detail.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 26 Sep 2024 02:52:43 GMT -->
                        ...
                        <div class="emplr-head-left">
                            ...
                            <div class="emplr-head-caption">
                                <div class="emplr-head-caption-top">
                                    <div class="emplr-yior-1"><span class="label text-sm-muted text-success bg-light-success">10 Openings</span></div>
                                    <div class="emplr-yior-2"><h4 class="emplr-title">Tripadvisor Inc.</h4></div>
                                    <div class="emplr-yior-3">
                                        <span><i class="fa-solid fa-building-shield me-1"></i>Software</span>
                                ...
                                <div class="row justify-content-start gx-3 gy-4">
                                    ...
                                    <div class="col-xl-12 col-lg-12 col-md-12">
                                        <div class="jbs-list-box border">
                                            <div class="jbs-list-head">
                                                <div class="jbs-list-head-thunner">
                                                    <div class="jbs-list-emp-thumb"><a href="job-detail.html"><figure><img src="../../WEB-INF/assets/img/l-5.png" class="img-fluid" alt=""></figure></a></div>
                                                    <div class="jbs-list-job-caption">
                                    ...
                                    <div class="col-xl-12 col-lg-12 col-md-12">
                                        <div class="jbs-list-box border">
                                            <div class="jbs-list-head">
                                                <div class="jbs-list-head-thunner">
                                                    <div class="jbs-list-emp-thumb"><a href="job-detail.html"><figure><img src="../../WEB-INF/assets/img/l-6.png" class="img-fluid" alt=""></figure></a></div>
                                                    <div class="jbs-list-job-caption">
                                                        <div class="jbs-job-types-wrap"><span class="label text-success bg-light-success">Full Time</span></div>
                                        ...
                                        <div class="reviewsCaption">
                                            <div class="reviewsHeader mb-3">
                                                ...
                                                <div class="d-flex align-items-center justify-content-start flex-wrap gap-2">
                                                    <div class="text-muted text-md"><a href="#" class="text-primary">Freelance VizRT</a>(Current Employee).</div>
                                                    <div class="text-muted text-md"><a href="#" class="text-primary">Washington, DC</a>.</div>
                                            ...
                                            <div class="reviewsDescription">
                                                <p>
                                                    <span class="d-block">What is the best part of working at the company?</span>
                                                ...
                                                <p>
                                                    <span class="d-block">What is the most stressful part about working at the company?</span>
                                                    <span>Relationship between employees is somewhat neutral unless there are sides and that’s when it gets awkward</span>
                                                </p>
                                                <p>
                                                    <span class="d-block">What is the work environment and culture like at the company?</span>
                                                    <span>Mostly professional, everyone keeps to themselves.</span>
                                                </p>
                                                <p>
                                                    <span class="d-block">What is a typical day like for you at the company?</span>
    ...
    <div class="modal fade" id="review" tabindex="-1" role="dialog" aria-labelledby="reviewmodal" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered filter-popup" role="document">
            <div class="modal-content" id="reviewmodal">
                <span class="mod-close" data-bs-dismiss="modal" aria-hidden="true"><i class="fas fa-close"></i></span>
                <div class="modal-header">
                    <h4 class="modal-header-sub-title">Share Your Feedback for Tripadvisor Inc.</h4>
                </div>
                <div class="modal-body p-0">
                    <div class="filter-content">
                        <div class="full-tabs-group">
                            <div class="single-tabs-group">
                                <div class="single-tabs-group-header"><h5>Do you approve of Fox Corporation's CEO?</h5></div>
                            ...
                            <div class="single-tabs-group">
                                <div class="single-tabs-group-header"><h5>Overall, I am completely satisfied with my job.</h5></div>

                                <div class="single-tabs-group-content">
                                    <div class="btn-group full-width">
                                        <button type="button" class="btn btn-md btn-outline-primary">1</button>
                                        <button type="button" class="btn btn-md btn-outline-primary">2</button>
                                        <button type="button" class="btn btn-md btn-outline-primary">3</button>
                                        <button type="button" class="btn btn-md btn-outline-primary">4</button>
                                        <button type="button" class="btn btn-md btn-outline-primary">5</button>
                                    </div>
                                </div>
                            </div>

                            <div class="single-tabs-group">
                                <div class="single-tabs-group-header"><h5>My work has a clear sense of purpose.</h5></div>
                            ...
                            <div class="single-tabs-group">
                                <div class="single-tabs-group-header"><h5>I feel happy at work most of the time.</h5></div>
                            ...
                            <div class="single-tabs-group">
                                <div class="single-tabs-group-header"><h5>I am paid fairly for my work.</h5></div>
                            ...
                            <div class="single-tabs-group">
                                <div class="single-tabs-group-header"><h5>I can trust people in my company.</h5></div>
                            ...
                            <div class="single-tabs-group">
                                <div class="single-tabs-group-header"><h5>My manager helps me succeed.</h5></div>
                            ...
                            <div class="single-tabs-group">
                                ...
                                <div class="single-tabs-group-content">
                                    <div class="d-flex flex-wrap">
                                        <textarea class="form-control ht-150">Explain your review</textarea>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="modal-footer">
                    <div class="filt-buttons-updates">
                        <button type="button" class="btn btn-dark">Close Review</button>
...
<!-- Mirrored from shreethemes.net/jobstock-landing-2.2/jobstock/employer-detail.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 26 Sep 2024 02:52:46 GMT -->
</html>