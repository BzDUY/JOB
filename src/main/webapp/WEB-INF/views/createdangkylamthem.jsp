...
<html lang="en">
    ...
    <body>
        ...
        <div class="form-container">
            ...
            <form:form action="${pageContext.request.contextPath}/lamthem/create" method="post" modelAttribute="lamthem">
                ...
                <div class="form-group">
                    ...
                    <a href="${pageContext.request.contextPath}/lamthem/list">Tro Ve Danh Sach Lam Them</a>
                </div>
            </form:form>
        </div>
    </body>
